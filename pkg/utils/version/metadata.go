...
func ReadVersionMetadata(targetPath string, fs afero.Afero) (*Info, error) {
	...
	if !exists {
		return nil, fmt.Errorf("base directory was generated by an older version of gardener-landscape-kit that did not track version information. Please regenerate the base directory (%s) with the current version", targetPath)
	}
