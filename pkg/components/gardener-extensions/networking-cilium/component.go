...
const (
	...
	ComponentDirectory = "gardener-extensions/networking-cilium"
)
...
func getTemplateValues(opts components.Options) (map[string]any, error) {
	return components.GetComponentVectorTemplateValues(opts, componentvector.NameGardenerGardenerExtensionNetworkingCilium)
}
