...
| `componentsYamlOverrides` _string array_ | ComponentsYamlOverrides lists additional components.yaml files layered on top of the in-repo base components.yaml.<br />Applied in declared order; later entries win. |  | Optional: \{\} <br /> |
...
| `componentsYamlOverrides` _string array_ | ComponentsYamlOverrides lists additional components.yaml files layered on top of the in-repo landscape components.yaml during `generate landscape`.<br />Applied in declared order; later entries win. |  | Optional: \{\} <br /> |
